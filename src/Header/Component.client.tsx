...
export const HeaderClient: React.FC<HeaderClientProps> = ({ data }) => {
  return (
    <header
      className="sticky w-full top-0 left-0 right-0  max-w-screen-2xl	 mx-auto w-full"
      style={{ zIndex: 40 }}
    >
...
const MobileMenu = ({ data }: HeaderClientProps) => {
    ...
    <Sheet onOpenChange={setOpen} open={open}>
      <div className="flex items-center px-4  py-2 justify-between bg-[rgba(0,0,0,0.8)]">
        ...
        <div className="flex gap-2 items-center">
          ...
          <span className="flex gap-2 font-fira-code font-bold text-2xl text-white"> JP</span>
        </div>
      </div>
...
const DesktopMenu = ({ data }: HeaderClientProps) => {
  return (
